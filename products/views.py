...
# this is a decorator that wraps around another function and return a new one with some additional functionality.
# This will make Django first check whether the user is logged in. Before executing the view.
# And if not it'll redirect them to the login page(This gives this some sort of security aspects )
@login_required
def add_product(request):
    """
    if the user is not a superuser.redirect them back to the
    home page with the message that only store owners can do that.
    """
